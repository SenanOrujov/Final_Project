        ...
        <div className='max-w-[500px] h-[550px] mx-auto bg-white/65 text-balck rounded-3xl'>
          <div className='max-w-[490px] mx-auto py-4  xl:py-16 md:py-12'>
            ...
            <form class='max-w-md mx-auto py-4 md:py-12 xl:py-16'>
              ...
              <button
                type='submit'
                class='text-black bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 mt-1'
              >
                Submit
              </button>
            </form>
